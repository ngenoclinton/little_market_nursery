...
const Navbar = () => {
  ...
  // Provide a fallback for pathname if it's null
  ...
  // After School Club submenu structure
  const afterSchoolClubSubmenu = [
    {
      category: "About Us",
      items: [
        { name: "Our People", path: "/after-school-club/our-people" },
        { name: "Our Parents", path: "/after-school-club/our-parents" },
        { name: "Our Activities", path: "/after-school-club/our-activities" },
        { name: "Our Policies", path: "/after-school-club/our-policies" },
        { name: "Our Prospectus", path: "/after-school-club/our-prospectus" },
      ],
    },
    {
      category: "Programs",
      items: [
        { name: "Holiday Club", path: "/after-school-club/holiday-club" },
        { name: "Activities", path: "/after-school-club/our-activities" },
      ],
    },
    {
      category: "Gallery",
      items: [
        { name: "All Galleries", path: "/after-school-club/gallery" },
        { name: "Activity Gallery", path: "/after-school-club/gallery/activity" },
        { name: "Holiday Club Gallery", path: "/after-school-club/gallery/holiday-club" },
        // { name: "Special Events", path: "/after-school-club/gallery/special-events" },
      ],
    },
    {
      category: "Contact & Registration",
      items: [
        { name: "Arrange A Visit", path: "/after-school-club/arrange-visit" },
        { name: "Ask A Question", path: "/after-school-club/ask-question" },
        { name: "Register Your Child", path: "/after-school-club/register" },
        { name: "Find Us", path: "/after-school-club/find-us" },
        { name: "Parental Contract", path: "/after-school-club/parental-contract" },
      ],
    },
  ]
            ...
            <ul className="flex justify-between">
              ...
              <li className="nav-item relative group">
                <Link
                  ...
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath.startsWith("/about-us") ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  About Us
                </Link>
              ...
              {/* After School Club - Updated with new structure */}
              <li className="nav-item relative group">
                <Link
                  href="/after-school-club"
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath.startsWith("/after-school-club") ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  After School Club
                </Link>
                <div className="dropdown-menu absolute left-0 top-full bg-white shadow-md min-w-[600px] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top scale-y-0 group-hover:scale-y-100 z-10 animate-fadeIn max-h-[500px] overflow-y-auto">
                  <div className="grid grid-cols-2 gap-0">
                    {afterSchoolClubSubmenu.map((category, index) => (
                      <div key={index} className="p-2">
                        <h3 className="font-medium text-[#3aa756] px-4 py-2 bg-gray-50 border-b border-gray-200">
                          {category.category}
                        </h3>
                        <ul>
                          {category.items.map((item, itemIndex) => (
                            <li key={itemIndex}>
                              <Link
                                href={item.path}
                                className="block py-2 px-4 text-[#3aa756] hover:bg-gray-100 hover:text-[#2d8444]"
                              >
                                {item.name}
                              </Link>
                            </li>
                  ...
                  <div className="p-4 bg-gray-50 border-t border-gray-200">
                    <Link
                      href="/after-school-club"
                      className="text-[#3aa756] hover:text-[#2d8444] font-medium flex items-center"
                    >
                      View All After School Club Information
              ...
              <li className="nav-item relative group">
                <Link
                  href="/curriculum"
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath.startsWith("/curriculum") ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  Curriculum
                </Link>
              ...
              <li className="nav-item relative group">
                <Link
                  href="/key-info"
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath.startsWith("/key-info") ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  Key Information
                </Link>
              ...
              <li className="nav-item relative group">
                <Link
                  href="/gallery"
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath.startsWith("/gallery") ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  Galleries
                </Link>
              ...
              <li className="nav-item relative group">
                <Link
                  href="/funding"
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath === "/funding" ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  Funding
                </Link>
              ...
              <li className="nav-item relative group">
                <Link
                  href="/contact"
                  className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                    currentPath.startsWith("/contact") ? "after:scale-x-100 bg-[#2d8444]" : ""
                  }`}
                >
                  Contact Us
                </Link>
        ...
        <div className="flex-grow overflow-hidden">
          <nav className="h-full overflow-y-auto custom-scrollbar p-4">
            <ul className="space-y-1">
              ...
              <li className="border-b border-gray-100">
                <div
                  className={`flex justify-between items-center py-3 px-4 text-lg font-medium ${
                    currentPath.startsWith("/about-us") ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
              ...
              {/* After School Club Mobile Menu Item - Updated with new structure */}
              <li className="border-b border-gray-100">
                <div
                  className={`flex justify-between items-center py-3 px-4 text-lg font-medium ${
                    currentPath.startsWith("/after-school-club") ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
                  } hover:text-[#3aa756] hover:bg-gray-50 rounded-md cursor-pointer`}
                ...
                <ul
                  className={`pl-4 mt-1 space-y-1 overflow-hidden transition-all duration-300 custom-scrollbar ${
                    activeDropdowns["after-school-club"] ? "max-h-[60vh] overflow-y-auto pb-2" : "max-h-0"
                  }`}
                >
                  <li>
                    <Link
                      href="/after-school-club"
                      className="block py-2 px-4 text-gray-600 hover:text-[#3aa756] hover:bg-gray-50 rounded-md font-medium"
                      onClick={handleMobileLinkClick}
                    >
                      Overview
                    </Link>
                  ...
                  {/* About Us Section */}
                  <li className="mt-3">
                    <div className="py-1 px-4 text-[#3aa756] font-medium bg-gray-50">About Us</div>
                    <ul className="mt-1">
                      <li>
                        <Link
                  ...
                  {/* Programs Section */}
                  <li className="mt-3">
                    <div className="py-1 px-4 text-[#fcb900] font-medium bg-gray-50">Programs</div>
                    <ul className="mt-1">
                      <li>
                        <Link
                  ...
                  {/* Gallery Section */}
                  <li className="mt-3">
                    <div className="py-1 px-4 text-[#fcb900] font-medium bg-gray-50">Gallery</div>
                    <ul className="mt-1">
                      <li>
                        <Link
                  ...
                  <li className="mt-3">
                    <div className="py-1 px-4 text-[#ff6900] font-medium bg-gray-50">Contact & Registration</div>
                    <ul className="mt-1">
                      <li>
                        <Link
                      ...
                      <li>
                        <Link
                          ...
                          className="block py-2 px-4 text-gray-600 hover:text-[#df2020] hover:bg-gray-50 rounded-md font-medium"
                          onClick={handleMobileLinkClick}
                        >
                          Parental Contract
                        </Link>
              ...
              <li className="border-b border-gray-100">
                <div
                  className={`flex justify-between items-center py-3 px-4 text-lg font-medium ${
                    currentPath.startsWith("/gallery") ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
                  } hover:text-[#3aa756] hover:bg-gray-50 rounded-md cursor-pointer`}
              ...
              <li className="border-b border-gray-100">
                <Link
                  href="/funding"
                  className={`block py-3 px-4 text-lg font-medium ${
                    currentPath === "/funding" ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
                  } hover:text-[#3aa756] hover:bg-gray-50 rounded-md`}
                  onClick={handleMobileLinkClick}
                >
                  Funding
              ...
              <li className="border-b border-gray-100">
                <div
                  className={`flex justify-between items-center py-3 px-4 text-lg font-medium ${
                    currentPath.startsWith("/contact") ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
                  } hover:text-[#3aa756] hover:bg-gray-50 rounded-md cursor-pointer`}
