              ...
              <ul className="flex justify-between">
                ...
                <li className="nav-item relative group">
                  <Link
                    href="/about"
                    className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                      pathname === "/about" ? "after:scale-x-100 bg-[#2d8444]" : ""
                    }`}
                  >
                    About Us
                  </Link>
                ...
                <li className="nav-item relative group">
                  <Link
                    href="/key-info"
                    className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                      pathname === "/key-info" ? "after:scale-x-100 bg-[#2d8444]" : ""
                    }`}
                  >
                    Key Information
                  </Link>
                ...
                <li className="nav-item relative group">
                  <Link
                    href="/safeguarding"
                    className={`block px-4 py-4 text-center hover:bg-[#2d8444] transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-white after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 ${
                      pathname === "/safeguarding" ? "after:scale-x-100 bg-[#2d8444]" : ""
                    }`}
                  >
                    Safeguarding
                  </Link>
          ...
          <nav className="p-4">
            <ul className="space-y-1">
              ...
              <li className="border-b border-gray-100">
                <div
                  className={`flex justify-between items-center py-3 px-4 text-lg font-medium ${
                    pathname .startsWith("/about") ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
              ...
              <li className="border-b border-gray-100">
                <div
                  className={`flex justify-between items-center py-3 px-4 text-lg font-medium ${
                    pathname .startsWith("/safeguarding") ? "text-[#3aa756] bg-gray-100" : "text-gray-800"
                  } hover:text-[#3aa756] hover:bg-gray-50 rounded-md cursor-pointer`}
